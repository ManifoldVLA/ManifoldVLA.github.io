...
// Clip: static/videos/visualshift_1.mp4, 23.4 s.
...
const PHASE_TIMES = [
  ...
  { t: 3.0,  key: 'grasp',             label: 'handoff \u2192 frozen VLA grasps' },
  { t: 12.0, key: 'transport-basket',  label: 'transport \u2192 box (cup attached)' },
  { t: 16.0, key: 'place',             label: 'handoff \u2192 frozen VLA places' },
  { t: 21.0, key: 'done',              label: 'sub-task goal reached' },
];
